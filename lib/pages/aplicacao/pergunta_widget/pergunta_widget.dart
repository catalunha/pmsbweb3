export 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_widget_texto.dart';
export 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_widget_numero.dart';
export 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_widget_escolha_unica.dart';
export 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_widget_escolha_multipla.dart';
export 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_wigdet_imagem_arquivo.dart';
export 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_wigdet_coordenada.dart';
import 'package:pmsbweb/models/pergunta_tipo_model.dart';
import 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_widget.dart';
import 'package:flutter_web/material.dart';
import 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_widget_texto.dart';
import 'package:pmsbweb/pages/aplicacao/pergunta_widget/pergunta_wigdet_imagem_arquivo.dart';
