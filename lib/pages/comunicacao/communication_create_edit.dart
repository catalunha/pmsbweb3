...
import 'package:pmsbweb/pages/comunicacao/area_checked_list.dart';
import 'package:pmsbweb/components/markdown.dart';
...
// --------- TELA DADOS ---------
  ...
  //https://github.com/dart-lang/markdown/blob/master/example/app.dart
  _bodyPreview(context) {
    return null;//markdownWidget(data: myController.text);
  }
        ...
        child: Scaffold(
          ...
          floatingActionButton: Padding(
              ...
              child: FloatingActionButton(
                onPressed: (){ 
                  // SALVAR ALTERACOES E RETORNAR A TELA ANTERIOR
