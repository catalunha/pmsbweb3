...
import 'package:pmsbweb/pages/comunicacao/comunicacao_destinatario_page.dart';
import 'package:pmsbweb/widgets/selecting_text_editing_controller.dart';
// import 'package:url_launcher/url_launcher.dart';

import 'package:pmsbweb/pages/comunicacao/comunicacao_crud_page_bloc.dart';
...
// --------- TELA DADOS ---------
  ...
  //   /**
  //    * TODO: verificar a forma de selecao de time na web
  //    */
      ...
      child: Row(
        ...
        children: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () {
              //TODO: consertar a selecao de horario
            ...
            children: <Widget>[
              ...
              ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed: () {
                      //TODO:launch("https://daringfireball.net/projects/markdown/");
                    },
                  )),
              _textoNoticia(),
            ],
  ...
  _bodyPreview(context) {
    return StreamBuilder<ComunicacaoCRUDPageState>(
        ...
        builder: (context, snapshot) {
          ...
          //TODO: colocar o visualizador de markdown correto
          return Container();//Markdown(data: myController.text);
        });
  }
