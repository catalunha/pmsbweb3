...
import 'package:pmsbweb/models/controle_acao_model.dart';
import 'package:pmsbweb/models/controle_tarefa_model.dart';
import 'package:pmsbweb/pages/controle/controle_acao_list_bloc.dart';
                      ...
                      children: <Widget>[
                        acao.url != null
                            ? IconButton(
                                ...
                                onPressed: () {
                                  // launch(acao.url);
                                  html.window.open(acao.url, "name");
                                },
                              )
                            : Text(''),
                        IconButton(
