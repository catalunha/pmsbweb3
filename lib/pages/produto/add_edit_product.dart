...
import 'package:pmsbweb/pages/user_files.dart';
...
class _AddEditProductState extends State<AddEditProduct> {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Expanded(
          flex: 4,
          child: Container(
            child: null//Markdown(data: myController.text),
          ),
        ),
        Visibility(
          child: new Container(
  ...
  Widget build(BuildContext context) {
    showFab = true; //MediaQuery.of(context).viewInsets.bottom == 0.0;
    myController.setTextAndPosition(_textoMarkdown);
